// Modified from antfu/markdown-it-github-alerts^23d2d84
...
const classPrefix = 'markdown-alert'

const plugin: PluginWithOptions = (md) => {
  md.core.ruler.after('block', 'github-alerts', (state) => {
    ...
    for (let i = 0; i < tokens.length; i++) {
      if (tokens[i].type === 'blockquote_open') {
        ...
        const match = firstContent.content
          .trimStart()
